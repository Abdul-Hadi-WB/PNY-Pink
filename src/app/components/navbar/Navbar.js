...
export default function Navbar() {
  ...
  return (
    <header>
      {/* =====================================================
          TOP BAR - Updated with Rasberry pink #C2366F
      ===================================================== */}
      <div
        className="
          bg-[#C2366F]
      ...
      >
        <div
          className="
            mx-auto flex min-h-[54px] max-w-7xl
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            {/* Email */}
            <a
              href="mailto:info@joinpnypink.com"
              className="
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="
                ...
                shadow-[0_5px_18px_rgba(22,163,74,0.35)]
                transition-all duration-300
                hover:-translate-y-0.5
                hover:from-[#22C55E]
                hover:to-[#16A34A]
                hover:shadow-[0_8px_25px_rgba(22,163,74,0.45)]
                sm:flex
              "
            >
              Enroll Now
      ...
      <div
        className="
          border-b border-[#C2366F]/20
          bg-white
          shadow-[0_5px_25px_rgba(194,54,111,0.08)]
        "
      >
        <div
          className="
          ...
          <div className="relative hidden lg:block">
            <button
              ...
              className="
                ...
                shadow-[0_6px_18px_rgba(194,54,111,0.22)]
                transition-all duration-300
                hover:-translate-y-0.5
                hover:shadow-[0_10px_28px_rgba(194,54,111,0.32)]
              "
            >
              <Grid3X3
                size={18}
            ...
            <div className="group relative">
              <input
                ...
                className="
                  ...
                  focus:border-[#A62258]
                  focus:bg-white
                  focus:ring-4 focus:ring-[#C2366F]/15
                  focus:shadow-[0_0_20px_rgba(194,54,111,0.18)]
                "
              />
